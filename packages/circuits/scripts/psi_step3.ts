...
program
  .requiredOption("--x <string>", "X coordinate of the request point")
  .requiredOption("--y <string>", "Y coordinate of the request point")
  .requiredOption("--client-rand <string>", "Temporary random scalar")
  .requiredOption("--output <string>", "Path of a ouput file to write the randomness");
