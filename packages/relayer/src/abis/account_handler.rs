...
pub mod account_handler {
    ...
    impl<M: ::ethers::providers::Middleware> AccountHandler<M> {
        ...
        ///Calls the contract's `dkimRegistryOfAccountSalt` (0xa99b6ac6) function
        ...
        ///Calls the contract's `isAccountSaltDeployed` (0xe2552706) function
        pub fn is_account_salt_deployed(
            &self,
            account_salt: [u8; 32],
        ) -> ::ethers::contract::builders::ContractCall<M, bool> {
            self.0
                .method_hash([226, 85, 39, 6], account_salt)
                .expect("method not found (this should never happen)")
        }
        ...
        ///Calls the contract's `updateDKIMRegistryOfAccountSalt` (0x40d20041) function
        pub fn update_dkim_registry_of_account_salt(
            ...
            self.0
                .method_hash([64, 210, 0, 65], (account_salt, dkim_registry))
                .expect("method not found (this should never happen)")
        }
        ...
        ///Calls the contract's `accountSaltOfPSIPoint` (0xc43e3996) function
    ...
    ///Container type for all input parameters for the `dkimRegistryOfAccountSalt` function with signature `dkimRegistryOfAccountSalt(bytes32)` and selector `0xa99b6ac6`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `isAccountSaltDeployed` function with signature `isAccountSaltDeployed(bytes32)` and selector `0xe2552706`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `updateDKIMRegistryOfAccountSalt` function with signature `updateDKIMRegistryOfAccountSalt(bytes32,address)` and selector `0x40d20041`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all input parameters for the `accountSaltOfPSIPoint` function with signature `accountSaltOfPSIPoint(bytes)` and selector `0xc43e3996`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    ///Container type for all return fields from the `dkimRegistryOfAccountSalt` function with signature `dkimRegistryOfAccountSalt(bytes32)` and selector `0xa99b6ac6`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `isAccountSaltDeployed` function with signature `isAccountSaltDeployed(bytes32)` and selector `0xe2552706`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
    ...
    ///Container type for all return fields from the `accountSaltOfPSIPoint` function with signature `accountSaltOfPSIPoint(bytes)` and selector `0xc43e3996`
    #[derive(
        Clone,
        ::ethers::contract::EthAbiType,
        ::ethers::contract::EthAbiCodec,
