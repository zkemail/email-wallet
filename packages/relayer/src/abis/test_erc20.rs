...
pub mod test_erc20 {
    ...
    impl<M> ::core::fmt::Debug for TestERC20<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(TestERC20))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for TestERC20Calls {
        fn decode(
            ...
            if let Ok(decoded) = <FreeMintCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::FreeMint(decoded));
            }
            if let Ok(decoded) =
                <FreeMintWithToCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for TestERC20Calls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::FreeMint(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::FreeMintWithTo(element) => ::ethers::core::abi::AbiEncode::encode(element),
