...
pub mod nft_extension {
    ...
    impl<M: ::ethers::providers::Middleware> NFTExtension<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, NFTExtensionEvents>
        {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for NFTExtension<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for NFTExtensionCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <AddressOfNFTNameCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <NameOfNFTAddressCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) = <SetNFTAddressCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::SetNFTAddress(decoded));
            }
            if let Ok(decoded) = <TemplatesCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiEncode for NFTExtensionCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                Self::AddressOfNFTName(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::NameOfNFTAddress(element) => ::ethers::core::abi::AbiEncode::encode(element),
                ...
                Self::SetNFTAddress(element) => ::ethers::core::abi::AbiEncode::encode(element),
                Self::Templates(element) => ::ethers::core::abi::AbiEncode::encode(element),
