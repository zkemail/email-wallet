...
contract TokenRegistry is Ownable {
    ...
    function getTokenAddress(
        ...
        if (keccak256(abi.encodePacked(chainName)) == keccak256(abi.encodePacked("optimism"))) {
            ...
            keccak256(abi.encodePacked(chainName)) == keccak256(abi.encodePacked("arbitrum"))
        ) {
            ...
            keccak256(abi.encodePacked(chainName)) == keccak256(abi.encodePacked("goerli"))
        ) {
            return tokens[tokenName].goerli;
        } else if (
            keccak256(abi.encodePacked(chainName)) == keccak256(abi.encodePacked("mainnet"))
        ) {
