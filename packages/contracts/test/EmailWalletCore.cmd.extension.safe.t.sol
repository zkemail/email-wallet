...
contract Safe2FAExtensionCommandTest is EmailWalletCoreTestHelper {
    ...
    SafeL2 safeAccount;
    address safeEOAOwner1 = vm.addr(11);
    ...
    function test_Safe2FAExtension_AuthTx() public {
        _addEmailOwner();
    ...
    function _authTxByEmail(bytes32 txHash) private {
        ...
        emailOp.maskedSubject = string.concat("Safe Transaction: Approve ", txHashStr, " from ", SubjectUtils.addressToChecksumHexString(address(safeAccount)));
        emailOp.extensionName = "Safe2FA";
